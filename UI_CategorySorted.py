...
class UI:
	...
	def loadImages(self):
		self.image = tk.PhotoImage(file="../img/zoom_icon.png")
	...
	def UI_CategorySorted(self):
		...
		for i, vid in enumerate(self.elements.video):
			...
			self.vid_checkbuttons.append(Checkbutton(self.frame, text = vid.title, \
				variable = self.vid_checkVar[i], onvalue=1, offvalue=0, height=28, \
				activebackground = "#D3D3D3", image = self.image, compound = "left"))
